  ...
  return (
    <>
      <div className="fixed bottom-0 left-0 right-0 bg-[#262626] p-2 h-16 flex justify-around">
        ...
        >
          <MdOutlineReorder className="mr-2" size={20} /> <p>Orders</p>
        </button>
        ...
        >
          <MdTableBar className="mr-2" size={20} /> <p>Tables</p>
        </button>
      ...
      <Modal isOpen={isModalOpen} onClose={closeModal} title="Create Order">
        ...
        <div>
          ...
          <div className='flex items-center justify-between bg-[#1f1f1f] px-4py-3 rounded-lg'>
